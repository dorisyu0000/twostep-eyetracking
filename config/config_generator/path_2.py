...
combinations = list(product(number_range, repeat=6))
...
def calculate_difficulty(combination):
    ...
    left_top,right_top, left_bottom_left, left_bottom_right, right_bottom_left, right_bottom_right = combination
    ...
    max_value = max(value_leftleft, value_leftright, value_rightleft, value_rightright)
    sum_value = value_leftleft + value_leftright + value_rightleft + value_rightright
    
    # Determine the primary measure of trial difficulty
    difficulty = max_value - ((sum_value - max_value)/3)
...
for i, combination in enumerate(combinations):
    ...
    if value_leftleft == value_leftright or value_leftleft == value_rightleft or value_leftleft == value_rightright or value_leftright == value_rightleft or value_leftright == value_rightright or value_rightleft == value_rightright:
        continue
...
with open(f"trials_2.json", "w") as file:
